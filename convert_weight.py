...
num_class = 80
img_size = 416
weight_path = './model_data/darknet_weights/yolov3.weights'
save_path = './model_data/darknet_weights/yolov3.ckpt'
anchors = parse_anchors('./model_data/yolo_anchors.txt')
